        ...
        post("/register_teacher", (req, res) -> {
            ...
            try {
                ...
                if (ps == null) {
                    ...
                    ps = new Person();
                    ps.set("dni", dni);
                    ps.set("firstName", firstName);
                    ps.set("lastName", lastName);
                    ps.set("phone", phone);
                    ps.set("email", email);
                    ps.saveIt();
                } else {
                ...
                if (existingTeacher != null) {
                    res.redirect("/register_teacher?error=Ya existe un profesor con el DNI " + dni);
                    return "";
                }
                ...
                th.set("nroLegajo", nroLegajo);
                th.saveIt();

                res.status(201);
                res.redirect("/register_teacher?message=Profesor registrado exitosamente para " + firstName + "!");
